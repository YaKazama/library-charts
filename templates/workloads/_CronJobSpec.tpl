...
{{- define "workloads.CronJobSpec" -}}
  ...
  {{- $__failedJobsHistoryLimit := include "base.toa" (coalesce .Context.failedJobsHistoryLimit .Values.failedJobsHistoryLimit) }}
  ...
  */ -}}
  ...
  {{- $__jobTemplate := include "definitions.JobTemplateSpec" . }}
  {{- if $__jobTemplate }}
    {{- nindent 0 "" -}}jobTemplate:
      {{- $__jobTemplate | nindent 2 }}
  {{- end }}
{{- end }}
