{{- define "definitions.RBDPersistentVolumeSource" -}}
  {{- with . }}
    ...
    {{- else }}
      {{- fail "definitions.RBDPersistentVolumeSource fsType not found" }}
    {{- end }}
    ...
    {{- $__secretRef := include "definitions.SecretReference" .secretRef | fromYaml }}
    {{- if $__secretRef }}
      {{- nindent 0 "" -}}secretRef:
